<article class="articles-card articles-card_small" style="background-image: url('{{ asset($item->picture->path ?? '') }}')">
	...
	<div class="articles-card__content">
		...
		<a class="link text_28 text_semi-bold text_white articles-card__info-title">{{ $item->title ?? ''}}</a>
