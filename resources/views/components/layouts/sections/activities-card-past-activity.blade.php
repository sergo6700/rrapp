<div class="activity-card activity-card_past-activity" itemscope itemtype="http://schema.org/Event">
	<div class="activity-card__date">
		<span class="text text_semi-bold text_73 text_red-1 activity-card__day">{{ $event->date_from->format('d') }}</span>
		<span class="text text_semi-bold text_58 text_red-1 activity-card__mouth">{{ formatMonthForView($event->date_from) }}</span>
		<span class="text text_semi-bold text_28 text_red-1 date_for_phone">{{ $event->date_from->format('d') }}</span>
		<span class="text text_semi-bold text_28 text_red-1 date_for_phone">{{ $event->date_from->locale('ru')->getTranslatedMonthName('Do MMMM') }}</span>
