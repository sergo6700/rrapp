<div class="activity-card activity-card_past-activity">
	...
	<div class="activity-card__content">
		...
		<div class="activity-card__contacts">
			<div class="activity-card__contacts-element">
				...
				<a class="link" href=""><span class="text text_17 text_black-3 activity-card__adress-text">Ростов-на-Дону, пер. Театральный, д.85 (4 этаж)</span></a>
			</div>
			<div class="activity-card__contacts-element">
				<div class="title-with-icon">
				...
				<a class="link" href=""><span class="text text_17 text_black-3 activity-card__organizer-text">Центр поддержки предпринимательства</span></a>
			</div>
		</div>
	</div>
</div>
