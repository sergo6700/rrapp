<div class="activity-card activity-card_past-activity activity-card_with-indent">
	<div class="activity-card__date">
		<span class="text text_semi-bold text_73 text_red-1 activity-card__day">03</span>
		<span class="text text_semi-bold text_58 text_red-1 activity-card__mouth">июля</span>
	</div>
	<div class="activity-card__content">
		<div class="activity-card__description">
			<h4 class="h4 activity-card__description-title">Семинар «Таргетированная реклама для бизнеса»</h4>
			<p class="text text_17 text_black-3">Instagram и ВКонтакте – соцсети, в которых можно и нужно зарабатывать. Для этого следует использовать эффективные стратегии продвижения, а также правильно настроить рекламу. Как это сделать? Расскажем на нашем ворк-шопе.</p>
		</div>
		<div class="activity-card__contacts">
			<div class="activity-card__contacts-element">
				<a class="link link_with-icon">
				...
				<span class="text text_17 text_black-3 activity-card__adress-text">Ростов-на-Дону, пер. Театральный, д.85 (4 этаж)</span>
			</div>
			<div class="activity-card__contacts-element">
				<a class="link link_with-icon">
				...
				<span class="text text_17 text_black-3 activity-card__organizer-text">Центр поддержки предпринимательства</span>
			</div>
		</div>
	</div>
</div>
