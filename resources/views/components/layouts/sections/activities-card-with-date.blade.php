<div class="activity-card" itemscope itemtype="http://schema.org/Event">
	<div class="activity-card__date">
		...
		<span class="text text_semi-bold text_58 text_red-1 activity-card__day">{{ formatMonthForView($event->date_from) }}</span>
