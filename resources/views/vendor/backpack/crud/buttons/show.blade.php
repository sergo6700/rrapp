@if ($crud->hasAccess('show'))
	...
	<!-- Single edit button -->
	<a href="{{ url($crud->route.'/'.$entry->getKey()) }}" class="btn btn-xs btn-default"><i class="fa fa-eye"></i>
	@if (strpos($crud->getAction()['controller'], 'ApplicationServiceCrudController') !== false)
